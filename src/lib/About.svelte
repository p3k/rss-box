...
<p class='msg warning'>
  <strong>This is a non-profit project running on a private server.</strong> If you like using it you should <a href='https://github.com/p3k/rss-box/blob/main/INSTALL.md'>host an installation on your own server</a> and/or support the project with your <a href='http://flattr.com/thing/681881/JavaScript-RSS-Box-Viewer'>donation</a>.
</p>

<p>
  This viewer can display <a href='http://en.wikipedia.org/wiki/RSS'>RSS</a> feeds of version <a href='http://cyber.law.harvard.edu/rss/examples/sampleRss091.xml' on:click={ goto }>0.91</a>, <a href='http://cyber.law.harvard.edu/rss/examples/sampleRss092.xml' on:click={ goto }>0.92</a>, <a href='http://rss.orf.at/fm4.xml' on:click={ goto }>1.0</a> and <a href='http://blog.p3k.org/stories.xml' on:click={ goto }>2.0</a> as well as even the good old legacy format <a href='http://essaysfromexodus.scripting.com/xml/scriptingNews2.xml' on:click={ goto }>Scripting News 2</a>. There is also basic support for <a href='https://www.theregister.co.uk/headlines.atom' on:click={ goto }>Atom 1.0</a>.
</p>
...
<p>
  The code behind this is written in JavaScript and runs completely in your browser*. You can get the source code together with all the other necessary files from the <a href='https://github.com/p3k/rss-box'>Github repository</a>.
</p>
...
<p>
  <a rel='license' href='http://creativecommons.org/licenses/by-sa/3.0/at/deed.en_US'>
    <img alt='Creative Commons License' style='border-width:0' src='https://i.creativecommons.org/l/by-sa/3.0/at/88x31.png'>
  </a>
</p>

<small>Thank you, <a href='https://p3k.org/'>p3k.org</a>!</small>
